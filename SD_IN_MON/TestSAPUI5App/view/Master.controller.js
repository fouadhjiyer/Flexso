sap.ui.core.mvc.Controller.extend("com.flexso.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "com.flexso.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	selectFirstItem : function() {
		...
		if (aItems.length) {
    		...
    		this.getRouter().myNavToWithoutHash({ 
    			currentView : this.getView(),
    			targetViewName : "com.flexso.view.NotFound",
    			targetViewType : "XML"
        	});
		}
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("FIRST_NAME", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
